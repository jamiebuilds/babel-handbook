...
# <a id="toc-setting-up-babel"></a>Babel instellen
...
# <a id="toc-configuring-babel"></a>Babel configureren
...
# <a id="toc-executing-babel-generated-code"></a>Babel-gegenereerde code uitvoeren
...
# <a id="toc-configuring-babel-advanced"></a>Babel configureren (Geavanceerd)

Most people can get by using Babel with just the built-in presets, but Babel exposes much finer-grained power than that.

## <a id="toc-manually-specifying-plugins"></a>Plugins handmatig specificeren
...
## <a id="toc-plugin-options"></a>Plugin opties
...
## <a id="toc-customizing-babel-based-on-environment"></a>Babel aanpassen gebaseerd op je omgeving
...
## <a id="toc-making-your-own-preset"></a>Je eigen preset maken
...
# <a id="toc-babel-and-other-tools"></a>Babel en andere tools
...
## <a id="toc-static-analysis-tools"></a>Tools voor statische analyse
