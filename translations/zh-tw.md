...
本指南涵蓋如何創作 [Babel](https://babeljs.io)
[plugins](https://babeljs.io/docs/advanced/plugins/)。

[![cc-by-4.0](https://licensebuttons.net/l/by/4.0/80x15.png)](http://creativecommons.org/licenses/by/4.0/)

特別感謝 [@sebmck](https://github.com/sebmck/)、[@hzoo](https://github.com/hzoo)、[@jdalton](https://github.com/jdalton)、[@abraithwaite](https://github.com/abraithwaite)、[@robey](https://github.com/robey) 及其他給予驚艷幫助的人。
...
現在只要輸入 `babel-plugin-handbook` 命令，便會開啟此說明文件到你的 `$PAGER`。要不然，你可以如同你現在所做的，繼續這篇指南。

# 翻譯

- [正體中文](/translations/zh-tw.md)
- [简体中文](/translations/cn.md)
...
- [基礎](#basics)
  - [AST 們](#asts)
  - [Babel 的階段](#stages-of-babel)
    - [Parse](#parse)
      - [詞法分析 Lexical Analysis](#lexical-analysis)
      - [語法分析 Syntactic Analysis](#syntactic-analysis)
    - [轉變 Transform](#transform)
    - [生成 Generate](#generate)
  - [走訪 Traversal](#traversal)
    - [訪客 Visitors](#visitors)
    - [路徑 Paths](#paths)
      - [訪客的路徑 Paths in Visitors](#paths-in-visitors)
    - [狀態 State](#state)
    - [範圍 Scopes](#scopes)
      - [繫結 Bindings](#bindings)
- [API](#api)
  - [babylon](#babylon)
  - [babel-traverse](#babel-traverse)
  - [babel-types](#babel-types)
    - [定義 Definitions](#definitions)
    - [建造者 Builders](#builders)
    - [驗證者 Validators](#validators)
    - [轉換者 Converters](#converters)
  - [babel-generator](#babel-generator)
  - [babel-template](#babel-template)
- [撰寫第一個 Babel Plugin](#writing-your-first-babel-plugin)
- [轉變操作 Transformation Operations](#transformation-operations)
  - [走訪 Visiting](#visiting)
    - [檢查 node 是否為特定類型](#check-if-a-node-is-a-certain-type)
    - [檢查 identifier 是否為參考引用](#check-if-an-identifier-is-referenced)
  - [操縱](#manipulation)
    - [替換 1 個 node](#replacing-a-node)
    - [將 1 個 node 替換成多個 node](#replacing-a-node-with-multiple-nodes)
    - [將 1 個 node 替換成原始字串](#replacing-a-node-with-a-source-string)
    - [插入 1 個同層級 node](#inserting-a-sibling-node)
    - [移除 1 個 node](#removing-a-node)
    - [替換 1 個父代](#replacing-a-parent)
    - [移除 1 個父代](#removing-a-parent)
  - [範圍 Scope](#scope)
    - [檢查區域變數是否已經繫結](#checking-if-a-local-variable-is-bound)
    - [生成 1 個 UID](#generating-a-uid)
    - [推送 1 個變數宣告到父代範圍](#pushing-a-variable-declaration-to-a-parent-scope)
    - [重新命名一個繫結及其參考引用](#rename-a-binding-and-its-references)
- [建造 Nodes](#building-nodes)
- [最佳實踐](#best-practices)
  - [盡可能避免走訪 AST](#avoid-traversing-the-ast-as-much-as-possible)
    - [允許時合併訪客](#merge-visitors-whenever-possible)
    - [可以手動查找就不要走訪](#do-not-traverse-when-manual-lookup-will-do)
  - [最佳化巢狀訪客](#optimizing-nested-visitors)
  - [察覺巢狀結構](#being-aware-of-nested-structures)
...
# 轉變操作 Transformation Operations
