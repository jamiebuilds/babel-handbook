...
# <a id="toc-setting-up-babel"></a>Babel のセットアップ
...
# <a id="toc-configuring-babel"></a>Babel の設定
...
## <a id="toc-static-analysis-tools"></a>静的解析ツール
...
## <a id="toc-text-editors-and-ides"></a>テキストエディタ・IDE
...
# <a id="toc-babel-support"></a>Babel のサポート
