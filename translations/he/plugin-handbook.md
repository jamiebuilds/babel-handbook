...
## <a id="toc-stages-of-babel"></a>השלבים של Babel

The three primary stages of Babel are **parse**, **transform**, **generate**.

### <a id="toc-parse"></a>ניתוח (Parse)
...
#### <a id="toc-lexical-analysis"></a>ניתוח מילולי (Lexical Analysis)
...
#### <a id="toc-syntactic-analysis"></a>ניתוח תחבירי (Syntactic Analysis)
...
### <a id="toc-transform"></a>שינוי צורה (Transform)
