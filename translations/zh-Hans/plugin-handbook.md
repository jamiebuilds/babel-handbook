...
有几种主要的方法来测试babel插件：快照测试，AST测试和执行测试。 对于这个例子，我们将使用`jest`，因为它支持盒外快照测试。 我们在这里创建的示例是托管在这个[repo](https://github.com/brigand/babel-plugin-testing-example)。 
...
> **对于将来的更新，请跟随 [@thejameskyle](https://twitter.com/thejameskyle) 和 [@babeljs](https://twitter.com/babeljs)  的Twitter。**
