...
> 这些API用于 babel-minify 中使用的 [transform-merge-sibling-variables](https://github.com/babel/babili/blob/master/packages/babel-plugin-transform-merge-sibling-variables/src/index.js) 插件.</p> </blockquote> 
> 
>
```js
