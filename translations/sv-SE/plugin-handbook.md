...
> Babel använder en AST modifierad från [ESTree](https://github.com/estree/estree), där kodspecifikationen kan hittas [här](https://github.com/babel/babel/blob/master/doc/ast/spec.md).
...
Samma program kan representeras som en lista så här:
...
## <a id="toc-stages-of-babel"></a>Stadier av Babel
...
#### <a id="toc-syntactic-analysis"></a>Syntaktisk analys
